...
// Pines que se utilizaran y de estado
...
const char* metricaUrl = "http://10.1.125.87:8000/metrica/";
...
void activateAlarms() {
  alertActive = true;
   for (int i = 0; i < 5; i++) {
    sta_led ? digitalWrite(rojo, HIGH) : (void)0;
    sta_vib ? digitalWrite(vib, HIGH) : (void)0;
    delay(100);
    digitalWrite(rojo, LOW);
    digitalWrite(vib, LOW);
    delay(100);
