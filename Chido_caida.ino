...
//const char* password="93DucK18!3312P"; //contrase;a
const char* ssid="WIFI EDIFICIO I";
const char* password="";


//Consttes de tiempo de envio
unsigned long lastSend = 0;
const unsigned long sendInterval = 15000; 
//const char* metricaUrl = "http://192.168.100.99:8000/metrica/"; //ip de la direccion de tu internet
